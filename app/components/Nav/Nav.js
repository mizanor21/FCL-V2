  ...
  const navItems = (
    <>
      ...
      <li className="relative group">
        ...
        <ul className="absolute  lg:left-[-370px] lg:w-[1530px] mt-10 hidden bg-white text-black shadow-md rounded-md group-hover:block  p-2">
      ...
      <li className="relative group">
        ...
        <ul className="absolute ease-in duration-1000 lg:left-[-850px] lg:w-[1530px] mt-10 hidden bg-white text-black shadow-md rounded-md group-hover:block  p-2">
          <div className="flex justify-center items-center gap-6 py-10">
