  ...
  const activities = [
    {
      ...
      imageURL:
        "https://i.postimg.cc/CMCpM21c/building-and-infrastructure-energy-gas-and-power.webp",
    },
    {
    ...
    },
    {
      ...
      description:
        "Farees Construction Limited is a full-service Construction firm offering comprehensive planning, design and Construction works including supervision, economic and financial analysis, environmental impact analysis, management of operation and maintenance under this sector.",
    ...
    },
    {
      ...
      imageURL:
        "https://i.postimg.cc/7Lprb80W/Transportation-and-communication.jpg",
    },
    {
    ...
    },
    {
      ...
      imageURL:
        "https://i.postimg.cc/mDCfHXS2/Information-and-Communication-Technology.webp",
    },
  ];
  ...
  return (
    <div>
      ...
      <div className="bg-gray-50 py-20">
        ...
        <div className="mt-10">
          <div className="px-4 lg:container lg:mx-auto lg:max-w-[1400px] grid grid-cols-1 md:grid-cols-3 gap-5">
            {activities.map((activity, index) => (
              <div
                key={index}
                className="transition-all duration-200 bg-white hover:shadow-xl rounded-xl"
              >
